<script setup lang="ts">
    ...
    const seo = getSeoData(appName, 'Dashboard')
</script>
            ...
            >
                ...
                >
                    <div class="max-w-3xl space-y-4">
                        ...
                        <div class="space-y-3">
                            <h1 class="text-3xl tracking-tight md:text-5xl">
                                Welcome back
                            </h1>
                            <p class="max-w-2xl text-sm leading-6 text-gray-400 md:text-base">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus magnam cumque quisquam, voluptate ipsam eos consequatur, alias deleniti corporis, neque voluptate ipsam eos consequatur
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <a href="#" class="rounded-xl bg-white px-4 py-3 text-sm text-black">
                            Button #2
                        </a>
                    </div>
                </div>

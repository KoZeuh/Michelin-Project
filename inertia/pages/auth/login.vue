...
<template>
  ...
  <main class="min-h-screen px-6 py-10 md:px-8 flex items-center">
    <div class="w-full max-w-[1180px] mx-auto grid gap-10 lg:grid-cols-[1fr_440px] items-center">
      ...
      <section class="rounded-3xl border border-white/10 bg-white/[0.07] p-6 md:p-8 shadow-2xl shadow-black/30">
          ...
          <div class="mt-8 space-y-5">
            <label class="block space-y-2">
              ...
              <div class="flex items-center gap-3 rounded-xl border border-white/10 bg-black/20 px-4 py-3">
                ...
                <input type="email" name="email" id="email" autocomplete="username" value="admin@schoolhub.io"
                  class="w-full bg-transparent text-sm text-white outline-none placeholder:text-gray-600"
                  placeholder="admin@schoolhub.io" :data-invalid="errors.email ? 'true' : undefined" />
              </div>
            ...
            <label class="block space-y-2">
              ...
              <div class="flex items-center gap-3 rounded-xl border border-white/10 bg-black/20 px-4 py-3">
                <span class="text-gray-500">#</span>
                <input type="password" name="password" id="password" autocomplete="current-password" value="demo-admin"
                  class="w-full bg-transparent text-sm text-white outline-none placeholder:text-gray-600"
                  placeholder="demo-admin" :data-invalid="errors.password ? 'true' : undefined" />
              </div>

<script setup lang="ts">
    ...
    const panelClasses = 'relative max-h-[calc(100vh-2rem)] overflow-hidden rounded-3xl border border-white/10 bg-[#0d0d14] shadow-[0_24px_80px_rgba(0,0,0,0.55)]'
    ...
    const footerClasses = 'flex flex-wrap items-center justify-end gap-3 border-t border-white/10 bg-black/10 p-5 md:p-6'

    const closeButtonClasses = 'flex h-10 w-10 shrink-0 cursor-pointer items-center justify-center rounded-xl border border-white/10 bg-white/[0.04] text-white transition-colors hover:bg-white/[0.08] hover:text-white'

    const cancelButtonClasses = 'inline-flex min-h-[42px] cursor-pointer items-center justify-center rounded-xl border border-white/10 bg-white/[0.03] px-5 text-sm text-white transition-colors hover:bg-white/[0.07]'
                                    ...
                                    <div :class="headerClasses">
                                        <div class="min-w-0">
                                            ...
                                            <p
                                                ...
                                                :id="descriptionId"
                                                :class="
                                                    [descriptionClasses, textToneClasses]
                                                "
                                            >
                                                {{ props.description }}
                                            </p>

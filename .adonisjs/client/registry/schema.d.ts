...
export interface Registry {
  ...
  'session.register': {
    ...
    types: {
      ...
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/session_controller').default['registerCreate']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/session_controller').default['registerCreate']>>>
    }
  }
  'session.registerStore': {
    ...
    types: {
      ...
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/session_controller').default['registerStore']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/session_controller').default['registerStore']>>> | { status: 422; response: { errors: SimpleError[] } }
    }
  }
  'session.destroy': {
    methods: ["DELETE"]
  ...
  'api.packs.generateCode': {
    ...
    types: {
      ...
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/api/packs_controller').default['generateCode']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/api/packs_controller').default['generateCode']>>>
    }
  }
  'home': {
    methods: ["GET","HEAD"]

...
const routes = {
  ...
  'api.drops.context': {
    ...
    tokens: [
      { old: '/api/drops/:dropId/context', type: 0, val: 'api', end: '' },
      { old: '/api/drops/:dropId/context', type: 0, val: 'drops', end: '' },
      { old: '/api/drops/:dropId/context', type: 1, val: 'dropId', end: '' },
      { old: '/api/drops/:dropId/context', type: 0, val: 'context', end: '' },
    ],
  ...
  'api.drops.packs': {
    ...
    tokens: [
      { old: '/api/drops/:dropId/packs', type: 0, val: 'api', end: '' },
      { old: '/api/drops/:dropId/packs', type: 0, val: 'drops', end: '' },
      { old: '/api/drops/:dropId/packs', type: 1, val: 'dropId', end: '' },
      { old: '/api/drops/:dropId/packs', type: 0, val: 'packs', end: '' },
    ],
  ...
  'api.products.reviews': {
    ...
    tokens: [
      { old: '/api/products/:productId/reviews', type: 0, val: 'api', end: '' },
      { old: '/api/products/:productId/reviews', type: 0, val: 'products', end: '' },
      { old: '/api/products/:productId/reviews', type: 1, val: 'productId', end: '' },
      { old: '/api/products/:productId/reviews', type: 0, val: 'reviews', end: '' },
    ],
  ...
  'api.packs.generateCode': {
    ...
    tokens: [
      { old: '/api/packs/generate-code', type: 0, val: 'api', end: '' },
      { old: '/api/packs/generate-code', type: 0, val: 'packs', end: '' },
      { old: '/api/packs/generate-code', type: 0, val: 'generate-code', end: '' },
    ],
